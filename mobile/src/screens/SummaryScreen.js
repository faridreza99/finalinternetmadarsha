...
const SummaryScreen = ({ navigation }) => {
  ...
  if (summary) {
    const summaryContent = summary.content || summary.summary || 'No content available';
    return (
      <SafeAreaView style={styles.container}>
        <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.gradient}>
          ...
          <View style={styles.metaCard}>
            <View style={styles.metaRow}>
              ...
              <Text style={styles.metaValue}>{summary.class_standard || selectedClass}</Text>
            </View>
            <View style={styles.metaRow}>
              <Text style={styles.metaLabel}>Subject:</Text>
              <Text style={styles.metaValue}>{summary.subject || selectedSubject}</Text>
            </View>
            {summary.chapter && (
              <View style={styles.metaRow}>
                <Text style={styles.metaLabel}>Chapter:</Text>
                <Text style={styles.metaValue}>{summary.chapter}</Text>
              </View>
            )}
          </View>
      ...
      <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.gradient}>
        ...
        <ScrollView style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            Get quick, structured summaries of your lessons and study materials
          </Text>
          ...
          >
            <LinearGradient
              colors={loading ? ['#555', '#444'] : ['#9b59b6', '#8e44ad']}
              style={styles.buttonGradient}
            >
              {loading ? (
          ...
          <Text style={styles.footerText}>
            Includes key points, main concepts, and structured overview
          </Text>
        </ScrollView>
      </LinearGradient>
    </SafeAreaView>
