...
const madrasahLabels = {
  ...
  displayNameHint: 'এই নামটি UI তে প্রদর্শিত হবে। আপনি বাংলা বা যেকোনো কাস্টম নাম ব্যবহার করতে পারেন।',
...
const schoolLabels = {
  ...
  displayNameHint: 'This name will be shown in the UI. You can use Bengali or any custom name.',
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="card-hover">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{labels.totalClasses}</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">
                  {institutionType === 'madrasah' ? toBengaliNumeral(classes.length) : classes.length}
                </p>
              </div>
        ...
        <Card className="card-hover">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{labels.totalSections}</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">
                  {institutionType === 'madrasah' ? toBengaliNumeral(sections.length) : sections.length}
                </p>
              </div>
        ...
        <Card className="card-hover">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{labels.totalSubjects}</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">
                  {institutionType === 'madrasah' ? toBengaliNumeral(subjects.length) : subjects.length}
                </p>
              </div>
        ...
        <Card className="card-hover">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{labels.assignedTeachers}</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">
                  {institutionType === 'madrasah' 
                    ? toBengaliNumeral(classes.filter(c => c.class_teacher_id).length + sections.filter(s => s.section_teacher_id).length)
      ...
      <Tabs defaultValue="classes" className="w-full">
        ...
        <TabsContent value="classes" className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold dark:text-white">{labels.classes}</h2>
            <Dialog open={isClassModalOpen} onOpenChange={setIsClassModalOpen}>
              ...
              <DialogContent className="dark:bg-gray-900">
                ...
                <form onSubmit={handleClassSubmit} className="space-y-4">
                  <div>
                    <Label htmlFor="standard" className="dark:text-gray-300">{labels.standard} *</Label>
                    <Select 
                    ...
                    >
                      ...
                      <SelectContent className="dark:bg-gray-800">
                        <SelectItem value="select_standard" disabled>{labels.selectStandard}</SelectItem>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder={institutionType === 'madrasah' ? 'যেমন: ইবতেদায়ী ১ম বর্ষ, নূরানী' : 'e.g., Class 1'}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="no_teacher">{labels.noTeacherAssigned}</SelectItem>
                        {staff.map((teacher) => (
                  ...
                  <div>
                    <Label htmlFor="max_students_class">{labels.maxStudents}</Label>
                    <Input
                  ...
                  <DialogFooter>
                    ...
                    <Button type="submit" className="bg-emerald-500 hover:bg-emerald-600" disabled={loading}>
                      {loading ? labels.saving : (editingClass ? labels.update : labels.save)}
                    </Button>
                  </DialogFooter>
                </form>
              </DialogContent>
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge variant="outline" className="dark:border-gray-600 dark:text-gray-300">
                              {institutionType === 'madrasah' ? toBengaliNumeral(getSectionsForClass(cls.id).length) : getSectionsForClass(cls.id).length} {labels.section}
                            </Badge>
                          </TableCell>
        ...
        <TabsContent value="sections" className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold dark:text-white">{labels.sections}</h2>
                ...
                <form onSubmit={handleSectionSubmit} className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="select_class" disabled>{labels.selectClass}</SelectItem>
                        {classes.map((cls) => (
                  ...
                  <div>
                    <Label htmlFor="section_teacher">{labels.sectionTeacher}</Label>
                    <Select 
                  ...
                  <div>
                    <Label htmlFor="max_students_section">{labels.maxStudents}</Label>
                    <Input
                  ...
                  <DialogFooter>
                    ...
                    <Button type="submit" className="bg-emerald-500 hover:bg-emerald-600" disabled={isSubmitting}>
                      {isSubmitting ? labels.saving : (editingSection ? labels.update : labels.save)}
                    </Button>
                  </DialogFooter>
                </form>
              </DialogContent>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-2">
                              {section.section_teacher_id ? (
                                ...
                                <span className="text-gray-500 text-sm">{labels.notAssigned}</span>
                              )}
                            </div>
                          </TableCell>
        ...
        <TabsContent value="subjects" className="space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-semibold dark:text-white">{labels.classSubjects}</h2>
              <Select 
            ...
            <Dialog open={isSubjectModalOpen} onOpenChange={setIsSubjectModalOpen}>
              ...
              <DialogContent>
                ...
                <form onSubmit={handleSubjectSubmit} className="space-y-4">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {classStandards.length > 0 ? (
                          ...
                          <SelectItem value="no_classes" disabled>{institutionType === 'madrasah' ? 'প্রথমে জামাত তৈরি করুন' : 'Please create classes first'}</SelectItem>
                        )}
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                    <Label htmlFor="subject_section">{labels.section} ({institutionType === 'madrasah' ? 'ঐচ্ছিক' : 'Optional'})</Label>
                    <Select 
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="all_sections">{labels.allSections}</SelectItem>
                    ...
                    <p className="text-xs text-gray-500 mt-1">{institutionType === 'madrasah' ? '"সকল শাখা" রাখুন পুরো জামাতে প্রযোজ্য হলে' : 'Leave as "All Sections" to apply to entire class'}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label htmlFor="subject_description">{institutionType === 'madrasah' ? 'বিবরণ' : 'Description'}</Label>
                    <Input
                      id="subject_description"
                      value={subjectFormData.description}
                      onChange={(e) => setSubjectFormData({...subjectFormData, description: e.target.value})}
                      placeholder={institutionType === 'madrasah' ? 'কিতাবের সংক্ষিপ্ত বিবরণ' : 'Brief description of the subject'}
                    />
                  </div>
                  <div className="flex items-center space-x-2">
                    <input
                    ...
                    />
                    <Label htmlFor="is_elective">{institutionType === 'madrasah' ? 'ঐচ্ছিক কিতাব' : 'Elective Subject'}</Label>
                  </div>
                  <DialogFooter>
                    <Button
                      type="button"
                    ...
                    <Button type="submit" className="bg-emerald-500 hover:bg-emerald-600" disabled={loading}>
                      {loading ? labels.saving : (editingSubject ? labels.update : labels.save)}
                    </Button>
                  </DialogFooter>
                </form>
              </DialogContent>
          ...
          {classStandards.length === 0 ? (
            <Card>
              <CardContent className="py-8 text-center text-gray-500">
                {institutionType === 'madrasah' ? 'এখনো কোনো জামাত তৈরি হয়নি। কিতাব যোগ করতে প্রথমে জামাত তৈরি করুন।' : 'No classes created yet. Please create classes first to add subjects.'}
              </CardContent>
            </Card>
          ) : (
                      ...
                      <CardContent className="pt-0 pb-4">
                        {classSubjects.length === 0 ? (
                          <div className="text-center py-4 text-gray-500 text-sm">
                            {institutionType === 'madrasah' ? 'এই জামাতে এখনো কোনো কিতাব যোগ করা হয়নি' : 'No subjects added for this class'}
                          </div>
                        ) : (
                          <div className="rounded-md border">
                            <Table>
                              <TableHeader>
                                <TableRow>
                                  ...
                                  <TableHead>{institutionType === 'madrasah' ? 'কোড' : 'Code'}</TableHead>
                                  <TableHead>{labels.section}</TableHead>
                                  <TableHead>{institutionType === 'madrasah' ? 'ধরন' : 'Type'}</TableHead>
                                  <TableHead>{labels.actions}</TableHead>
                                </TableRow>
                              </TableHeader>
                              <TableBody>
                                    ...
                                    <TableCell>
                                      <Badge variant="secondary" className="text-xs">
                                        {subject.section_id 
                                          ...
                                          : (institutionType === 'madrasah' ? 'সকল' : 'All')
                                        }
                                      </Badge>
                                    </TableCell>
                                    <TableCell>
                                      {subject.is_elective ? (
                                        <Badge className="bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300">
                                          {institutionType === 'madrasah' ? 'ঐচ্ছিক' : 'Elective'}
                                        </Badge>
                                      ) : (
                                        <Badge className="bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300">
                                          {institutionType === 'madrasah' ? 'আবশ্যিক' : 'Core'}
                                        </Badge>
                                      )}
                                    </TableCell>
                                    <TableCell>
